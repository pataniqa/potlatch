...
public class ListStoryActivity extends StoryActivityBase {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        aa = new StoryDataArrayAdaptor(this, R.layout.story_listview_custom_row, mStoryData);
        ...
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            public void onItemClick(AdapterView<?> parent, View v, int position, long id) {
                ...
                Log.d(LOG_TAG, "position: " + position + "id = " + (mStoryData.get(position)).KEY_ID);
...
//        searchView.setSearchableInfo(searchManager.getSearchableInfo(getComponentName()));
    ...
    // When the refresh button is clicked, update our local StoryData ArrayList
    ...
    public void updateStoryData() {
        ...
        try {
            ...
            ArrayList<StoryData> currentList2 = resolver.queryStoryData(null, PotlatchSchema.Story.Cols.TAGS
