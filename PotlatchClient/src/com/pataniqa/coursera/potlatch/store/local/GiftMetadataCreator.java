...
public class GiftMetadataCreator extends BaseCreator<GiftMetadata> implements Creator<GiftMetadata> {
    ...
    public ContentValues getCV(GiftMetadata data) {
        ...
        rValue.put(PotlatchSchema.GiftMetadata.Cols.GIFT_CHAIN_NAME, data.giftChainName);
        return rValue;
    }
    ...
    public GiftMetadata getFromCursor(Cursor cursor) {
        ...
        long giftID = cursor.getLong(cursor
                .getColumnIndex(PotlatchSchema.GiftMetadata.Cols.GIFT_ID));
        ...
        boolean flagged = cursor.getInt(cursor
                .getColumnIndex(PotlatchSchema.GiftMetadata.Cols.FLAGGED)) > 0;
        long giftChainID = cursor.getLong(cursor
                .getColumnIndex(PotlatchSchema.GiftMetadata.Cols.GIFT_CHAIN_ID));
        String giftChainName = cursor.getString(cursor
                .getColumnIndex(PotlatchSchema.GiftMetadata.Cols.GIFT_CHAIN_NAME));
