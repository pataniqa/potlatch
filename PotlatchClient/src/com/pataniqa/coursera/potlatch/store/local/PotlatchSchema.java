...
public class PotlatchSchema {
    ...
    public static class GiftMetadata {
        // define a URI paths to access entity
        // BASE_URI/giftmetadata - for list of gifts(s)
        // BASE_URI/giftmetadata/* - retrieve specific gift by id
        public static final String PATH = "giftmetadata";
        public static final int PATH_TOKEN = 110;
